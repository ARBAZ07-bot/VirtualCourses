...
function Nav() {
  ...
  return (
    ...
    <div className={`fixed  top-0 w-full h-[100vh] bg-[#000000d6] flex items-center justify-center flex-col gap-5 z-10 ${showHam?"translate-x-[0%] transition duration-[600ms]  ease-in-out" :"translate-x-[-100%] transition duration-[600ms]  ease-in-out"}`}>
