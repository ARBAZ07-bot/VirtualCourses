    ...
    <footer className="bg-black text-gray-300 py-10 px-6">
      <div className="max-w-7xl mx-auto flex lg:items-center items-start justify-center gap-[40px] lg:gap-[150px] flex-col lg:flex-row">
        ...
        <div className="lg:w-[30%] md:w-[100%]">
          ...
          <ul className="space-y-1 text-sm">
            <li className="hover:text-white cursor-pointer" onClick={() => navigate("/allcourses")}>Web Development</li>
            <li className="hover:text-white cursor-pointer" onClick={() => navigate("/allcourses")}>AI/ML</li>
            <li className="hover:text-white cursor-pointer" onClick={() => navigate("/allcourses")}>Data Science</li>
            <li className="hover:text-white cursor-pointer" onClick={() => navigate("/allcourses")}>UI/UX Design</li>
          </ul>
        </div>
