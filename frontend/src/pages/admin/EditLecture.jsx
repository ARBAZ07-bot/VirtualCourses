...
function EditLecture() {
    ...
    // Agar lecture data abhi load nahi hua (jaise page refresh), crash hone se bachao
    if (!selectedLecture) {
      return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4 gap-4">
          <p className="text-gray-600">Lecture not found. Please go back and try again.</p>
          <button className="px-4 py-2 bg-black text-white rounded-md" onClick={()=>navigate(`/createlecture/${courseId}`)}>Back to Lectures</button>
        </div>
      )
    }
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-xl bg-white rounded-xl shadow-lg p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Video (leave empty to keep current video)</label>
            <input
              type="file"
              accept='video/*'
